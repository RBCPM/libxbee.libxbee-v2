...
int xbee_sG_localAtTx(struct xbee *xbee, struct xbee_pktHandler *handler, struct bufData **buf) { return 0; }
int xbee_sG_localAtQueue(struct xbee *xbee, struct xbee_pktHandler *handler, struct bufData **buf) { return 0; }
